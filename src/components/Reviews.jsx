...
import './Reviews.css';
import Person1 from '../utils/img/person1a.jpg';
import Person2 from '../utils/img/person2a.jpg';
import Person3 from '../utils/img/person3a.jpg';
import Person4 from '../utils/img/person4a.jpg';

export function Reviews() {
    return (
        <div className="reviews-section container">
            <h2 className="text-center mb-5 text-uppercase fw-bold fs-1">Yorumlar</h2>
                ...
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Berk</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">İrem</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Sueda</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        ...
                        <CardFooter className="d-flex align-items-center">
                            ...
                            <CardTitle className="text-success">Mert</CardTitle>
                        </CardFooter>
                    </Card>
                </div>
            </div>
